...
- A proposed library, pattern, module, or seam must be grounded in the existing contracts, modules, adapters, tests, and dependencies. Missing repository context is an evidence need for the caller.
...
Apply [testing evidence](../../verification-design/SKILL.md), the single owner of testing law:
...
migration path; missing execution evidence remains a need for the caller.
