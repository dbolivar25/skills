# Engineering restraint core

Read the [core/shell contract](../contracts/core-shell.md).

**Inputs:** Protected outcome, proposed addition, current necessity and alternatives evidence, continuing commitments, constraints, authority and settled owner choices.

An addition earns its complexity when present evidence justifies its value and
continuing ownership cost. Apply this judgment before committing to an addition;
...
Use supplied current-system evidence to judge whether deletion, reuse,
...
[decision-rights core](../decision-rights/core.md), using the supplied authority
and settlement. A recommendation does not create blocking authority.
