...
idea is unlikely to be the best. Apply [module design](../../module-design/references/design.md)
and classify dependencies using [dependency seams](../../module-design/references/dependency-seams.md).
