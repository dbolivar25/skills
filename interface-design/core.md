...
**Inputs:** User moment, supplied surface/source/render observations, platform/category and brand constraints, states/viewport context, chosen direction and task mode (design or assessment).
...
Use [decision rights](../decision-rights/core.md) for a proposed objection with
supplied owner/authority evidence. For a needed interaction experiment, use
[prototype design](../prototype/core.md) with the unresolved question and
constraints. Return the experiment need; the shell owns construction and testing.
