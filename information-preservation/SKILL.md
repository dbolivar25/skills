...
The caller supplies source material or a proposed transformation, its consumers,
and the judgments those consumers must make. Return a preservation contract and,
...
claim requires inspection of both source and candidate. The caller owns writing,
