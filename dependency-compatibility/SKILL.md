...
**Inputs:** Exact old/new versions, resolved lock graph, runtime envelope, repository
usage evidence and primary upstream release/migration records for the interval.
...
Return a compatibility assessment to the caller: affected usage, migration obligations,
...
and supported API documentation. Compare the supplied installed or resolved version with
...
combines this assessment with its own decision criteria. A review includes request fit,
