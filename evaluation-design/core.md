# Evaluation design core

Read the [core/shell contract](../contracts/core-shell.md).

**Inputs:** Intended behavior/quality obligations, candidate or proposed system, available examples and prior results, failure consequences, decision criteria and execution constraints.

Return a runnable evaluation plan: cases, observations,
